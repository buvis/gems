...
class TestBimCliHelp:
    ...
    def test_import_help(self, runner) -> None:
        result = runner.invoke(cli, ["import", "--help"])
        assert result.exit_code == 0
        assert "Import a note" in result.output

    def test_format_help(self, runner) -> None:
