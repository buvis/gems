...
class TestSysupPipCommand:
    ...
    @patch("sysup.commands.pip.pip.CommandPip")
    def test_pip_failure_step(self, mock_cmd_cls: MagicMock) -> None:
        mock_cmd_cls.return_value.execute.return_value = [
...
class TestSysupWslCommand:
    @patch("sysup.cli.sys")
    def test_wsl_wrong_platform(self, mock_sys: MagicMock) -> None:
    ...
    @patch("sysup.cli.sys")
    def test_wsl_success(self, mock_sys: MagicMock, mock_cmd_cls: MagicMock) -> None:
    ...
    @patch("sysup.commands.wsl.wsl.CommandWsl")
    @patch("sysup.cli.sys")
    def test_wsl_fatal_error(self, mock_sys: MagicMock, mock_cmd_cls: MagicMock) -> None:
