...
class TestHelloWorldCliExtra:
    ...
    def test_diag_no_output(self, mock_cmd_cls: MagicMock) -> None:
    ...
    def test_random_font(self, mock_cmd_cls: MagicMock) -> None:
    ...
    @patch("hello_world.commands.print_figlet.print_figlet.CommandPrintFiglet")
    def test_invalid_font_falls_back(self, mock_cmd_cls: MagicMock) -> None:
        mock_cmd_cls.return_value.execute.return_value = CommandResult(success=True, output="styled")
        runner = CliRunner()
    ...
    @patch("hello_world.commands.print_figlet.print_figlet.CommandPrintFiglet")
    def test_text_no_output(self, mock_cmd_cls: MagicMock) -> None:
        mock_cmd_cls.return_value.execute.return_value = CommandResult(success=True)
        runner = CliRunner()
