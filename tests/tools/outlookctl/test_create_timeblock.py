...
class TestCommandCreateTimeblockInit:
    def test_init_stores_duration(self) -> None:
        with (
            patch("outlookctl.commands.create_timeblock.create_timeblock.os.name", "posix"),
            patch("outlookctl.commands.create_timeblock.create_timeblock.console.warning"),
        ):
    ...
    def test_init_non_windows_warns(self) -> None:
        with (
            patch("outlookctl.commands.create_timeblock.create_timeblock.os.name", "posix"),
            patch("outlookctl.commands.create_timeblock.create_timeblock.console.warning") as warning_mock,
        ):
