...
class TestOutlookctlCreateTimeblock:
    ...
    def test_create_timeblock_success(self, mock_os: MagicMock, mock_cmd_cls: MagicMock) -> None:
        mock_os.name = "nt"
    ...
    @patch("outlookctl.commands.create_timeblock.create_timeblock.CommandCreateTimeblock")
    @patch("outlookctl.cli.os")
    def test_create_timeblock_failure(self, mock_os: MagicMock, mock_cmd_cls: MagicMock) -> None:
        mock_os.name = "nt"
    ...
    @patch("outlookctl.commands.create_timeblock.create_timeblock.CommandCreateTimeblock")
    @patch("outlookctl.cli.os")
    def test_create_timeblock_failure_no_error(self, mock_os: MagicMock, mock_cmd_cls: MagicMock) -> None:
        mock_os.name = "nt"
    ...
    @patch("outlookctl.commands.create_timeblock.create_timeblock.CommandCreateTimeblock")
    @patch("outlookctl.cli.os")
    def test_create_timeblock_fatal_error(self, mock_os: MagicMock, mock_cmd_cls: MagicMock) -> None:
        mock_os.name = "nt"
    ...
    @patch("outlookctl.commands.create_timeblock.create_timeblock.CommandCreateTimeblock")
    @patch("outlookctl.cli.os")
    def test_create_timeblock_success_no_output(self, mock_os: MagicMock, mock_cmd_cls: MagicMock) -> None:
        mock_os.name = "nt"
