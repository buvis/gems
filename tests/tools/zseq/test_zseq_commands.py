...
class TestZseqCommands:
    ...
    def test_get_last_success(self, mock_cmd_cls: MagicMock, runner, tmp_path) -> None:
    ...
    @patch("zseq.commands.get_last.get_last.CommandGetLast")
    def test_get_last_with_misnamed(self, mock_cmd_cls: MagicMock, runner, tmp_path) -> None:
    ...
    @patch("zseq.commands.get_last.get_last.CommandGetLast")
    def test_get_last_failure(self, mock_cmd_cls: MagicMock, runner, tmp_path) -> None:
