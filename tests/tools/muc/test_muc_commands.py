...
class TestMucCommands:
    ...
    def test_cover_success(self, mock_cmd_cls: MagicMock, runner, tmp_path) -> None:
    ...
    @patch("muc.commands.cover.cover.CommandCover")
    def test_cover_failure(self, mock_cmd_cls: MagicMock, runner, tmp_path) -> None:
    ...
    def test_cover_not_a_dir(self, runner, tmp_path) -> None:
    ...
    @patch("muc.shared.dir_tree.DirTree")
    def test_tidy_success(self, mock_dirtree: MagicMock, mock_cmd_cls: MagicMock, runner, tmp_path) -> None:
    ...
    def test_tidy_not_a_dir(self, runner, tmp_path) -> None:
