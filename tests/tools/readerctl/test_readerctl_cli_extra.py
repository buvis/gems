...
class TestReaderctlLoginExtra:
    ...
    def test_login_success_no_output(self, mock_cmd_cls: MagicMock) -> None:
    ...
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_login_failure_no_error(self, mock_cmd_cls: MagicMock) -> None:
    ...
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_login_fatal_error(self, mock_cmd_cls: MagicMock) -> None:
...
class TestReaderctlAddExtra:
    ...
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_url_failure(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock) -> None:
    ...
    @patch("readerctl.commands.add.add.CommandAdd")
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_login_failure(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock) -> None:
    ...
    @patch("readerctl.commands.add.add.CommandAdd")
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_login_fatal_error(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock) -> None:
    ...
    @patch("readerctl.commands.add.add.CommandAdd")
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_from_file(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock, tmp_path) -> None:
        mock_login_cls.return_value.execute.return_value = CommandResult(
            success=True, output="ok", metadata={"token": "tok"}
        )
    ...
    @patch("readerctl.commands.add.add.CommandAdd")
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_from_file_failure(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock, tmp_path) -> None:
        mock_login_cls.return_value.execute.return_value = CommandResult(
            success=True, output="ok", metadata={"token": "tok"}
        )
    ...
    @patch("readerctl.commands.add.add.CommandAdd")
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_from_file_not_found(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock) -> None:
        mock_login_cls.return_value.execute.return_value = CommandResult(
            success=True, output="ok", metadata={"token": "tok"}
        )
        runner = CliRunner()
    ...
    @patch("readerctl.commands.add.add.CommandAdd")
    @patch("readerctl.commands.login.login.CommandLogin")
    def test_add_no_url_no_file(self, mock_login_cls: MagicMock, mock_add_cls: MagicMock) -> None:
        runner = CliRunner()
        result = runner.invoke(cli, ["add"])
        assert "Not logged in" in result.output

    def test_add_import_error(self) -> None:
