...
from buvis.pybase.zettel.domain.entities.zettel.fixers.fix_title_format import (
    fix_title_format,
)
...
class TestFixTitleFormat:
    def test_fix_title_format(self, sample_zettel_data):
    ...
    def test_fix_title_format_whitespace_only_title(self):
        zettel_data = ZettelData()
    ...
    def test_fix_title_format_idempotence(self, sample_zettel_data):
