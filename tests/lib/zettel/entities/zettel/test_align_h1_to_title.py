...
from buvis.pybase.zettel.domain.entities.zettel.fixers.align_h1_to_title import (
    align_h1_to_title,
)
from buvis.pybase.zettel.domain.value_objects.zettel_data import ZettelData


class TestAlignH1ToTitle:
    ...
    def test_non_heading_first_section(self):
        zettel = ZettelData()
        zettel.metadata = {"title": "Test Title"}
    ...
    def test_no_heading_but_empty_string(self):
        zettel = ZettelData()
        zettel.metadata = {"title": "Test Title"}
