...
class TestRemoveDuplicateTags:
    def test_remove_duplicate_tags(self, sample_zettel_data: ZettelData):
    ...
    def test_remove_duplicate_tags_unique_tags(self):
    ...
    def test_remove_duplicate_tags_empty_tags(self):
