...
class TestProcessMetadata:
    ...
    def test_process_metadata(self, sample_metadata: dict):
...
class TestConvertDatetimes:
    ...
    def test_convert_datetimes(self, sample_metadata: dict):
...
class TestMetadataToYaml:
    ...
    def test_metadata_to_yaml(self, sample_metadata: dict):
...
class TestFormatMetadata:
    ...
    def test_format_metadata(self, sample_metadata: dict):
        first_keys = ("name", "email")
