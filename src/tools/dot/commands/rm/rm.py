...
class CommandRm:
    ...
    def _remove_normal(self: CommandRm) -> CommandResult:
        ...
        return CommandResult(success=True, output=f"{self.file_path} removed from dotfiles")
    ...
    def _remove_encrypted(self: CommandRm) -> CommandResult:
        ...
        return CommandResult(success=True, output=f"{self.file_path} removed from git-secret and disk")
