...
class ProjectZettel(Zettel):
    ...
    Inherits from Zettel and adds project-specific methods for data migration and consistency checks.
    """

    def __init__(self, zettel_data: ZettelData | None = None, *, from_rust: bool = False) -> None:
        """Initialize the ProjectZettel instance by calling the initializer of the superclass Zettel."""
    ...
    def migrate(self: ProjectZettel) -> None:
        ...
        Returns:
            None. The function modifies the internal state in place.
        """
        super().migrate()
    ...
    def log(self: ProjectZettel) -> str:
        ...
        Returns:
            The content of the log section if it exists, otherwise an empty string.
        """
        return next(
    ...
    def us(self: ProjectZettel) -> str | None:
        ...
        Returns:
            The content of reference field with us key.
        """
